...
hsuScript is a teaching compiler written in C that implements a complete pipeline from source text to x86-64 binaries. It includes lexing, parsing, semantic analysis, code generation, and a bundled runtime.
...
Building each compiler stage from scratch clarified how ABI details, stack management, and code generation work without relying on existing abstractions. The project serves as a reference for understanding how source text becomes native code.
