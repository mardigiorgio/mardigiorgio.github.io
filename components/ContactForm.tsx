  ...
  return (
    ...
    >
      <label className="block">
        <span className="text-sm block text-center">Your Email</span>
      ...
      <label className="block">
        <span className="text-sm block text-center">Message</span>
      ...
      <button className="rounded-xl bg-neutral-900 text-white dark:bg-white dark:text-neutral-900 px-4 py-2 block mx-auto">Send</button>
      {status === 'sent' ? <p className="text-sm opacity-70 text-center">Thanks! I’ll get back to you soon.</p> : null}
    </form>
  )
}
